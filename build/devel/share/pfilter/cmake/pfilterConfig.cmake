...
if(pfilter_CONFIG_INCLUDED)
  return()
endif()
set(pfilter_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(pfilter_SOURCE_PREFIX /home/r/catkin_wss/pfilter_ws/PFilter-noetic)
  set(pfilter_DEVEL_PREFIX /home/r/catkin_wss/pfilter_ws/PFilter-noetic/build/devel)
  set(pfilter_INSTALL_PREFIX "")
  set(pfilter_PREFIX ${pfilter_DEVEL_PREFIX})
else()
  set(pfilter_SOURCE_PREFIX "")
  set(pfilter_DEVEL_PREFIX "")
  set(pfilter_INSTALL_PREFIX /usr/local)
  set(pfilter_PREFIX ${pfilter_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'pfilter' is deprecated")
...
set(pfilter_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/r/catkin_wss/pfilter_ws/PFilter-noetic/include;/usr/local/include/eigen3;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(pfilter_INCLUDE_DIRS "")
  set(_include_dirs "/home/r/catkin_wss/pfilter_ws/PFilter-noetic/include;/usr/local/include/eigen3;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "https://yjsx.top " STREQUAL " ")
    set(_report "Check the website 'https://yjsx.top' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Yifan Duan <dyf0202@mail.ustc.edu.cn>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${pfilter_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pfilter' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'pfilter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/r/catkin_wss/pfilter_ws/PFilter-noetic/${idir}'.  ${_report}")
    endif()
    _list_append_unique(pfilter_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND pfilter_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND pfilter_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT pfilter_NUM_DUMMY_TARGETS)
      set(pfilter_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::pfilter::wrapped-linker-option${pfilter_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR pfilter_NUM_DUMMY_TARGETS "${pfilter_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::pfilter::wrapped-linker-option${pfilter_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND pfilter_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/r/catkin_wss/pfilter_ws/PFilter-noetic/build/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(pfilter_LIBRARY_DIRS ${lib_path})
      list(APPEND pfilter_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'pfilter'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND pfilter_LIBRARIES ${lib})
    endif()
  endif()
...
set(pfilter_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${pfilter_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 pfilter_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${pfilter_dep}_FOUND)
      find_package(${pfilter_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pfilter_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(pfilter_INCLUDE_DIRS ${${pfilter_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(pfilter_LIBRARIES ${pfilter_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${pfilter_dep}_LIBRARIES})
  _list_append_deduplicate(pfilter_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(pfilter_LIBRARIES ${pfilter_LIBRARIES})

  _list_append_unique(pfilter_LIBRARY_DIRS ${${pfilter_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(pfilter_EXPORTED_TARGETS ${${pfilter_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${pfilter_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
